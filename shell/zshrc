...
export SHELL_ROOT="$DOTFILE/shell"
SUB_MODULES="$SHELL_ROOT/submodules"
SYSTEM_FOLDER="$DOTFILE/os/$SYSTEM"

fpath=( "$SHELL_ROOT/function.d" "$SHELL_ROOT/function.d/**/*~*/" $fpath )
...
sources+="$SHELL_ROOT/vim_mode.zsh"
sources+="$SHELL_ROOT/alias/alias.sh"
sources+="$SHELL_ROOT/alias/alias_git.sh"
...
sources+="$SHELL_ROOT/function.d/lazynvm"
sources+="$SHELL_ROOT/os/$SYSTEM/load.zsh"
sources+="$SHELL_ROOT/local.sh"
